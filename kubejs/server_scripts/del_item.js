...
onEvent('recipes', event => {
	...
	event.remove({id : /.*(ingot|wool|button|raw|nugget).*/,									type : RECIPE_TYPE.MC_SHAPELESS})
	...
	event.remove({output : CREATE_ITEMS.ANDESITE_ALLOY,											type : RECIPE_TYPE.MC_SHAPED})
	event.remove({output : CREATE_ITEMS.ANDESITE_ALLOY,											type : RECIPE_TYPE.MC_SHAPELESS})
	event.remove({output : `#${TAGS.C_SANDPAPER}`,												type : RECIPE_TYPE.MC_SHAPELESS})
	event.remove({output : `#${TAGS.M_WOODEN_PRESSURE_PLATES}`,									type : RECIPE_TYPE.MC_SHAPED})
	event.remove({output : `#${TAGS.M_WOODEN_TRAPDOORS}`,										type : RECIPE_TYPE.MC_SHAPED})

...
onEvent('recipes', event => {
	...
	event.remove({id : 'tconstruct:smeltery/entity_melting/heads/creeper'})
	...
	event.remove({id : 'tfc:heating/glass_from_sand'})
	
	event.remove({id : 'productivebees:bee_produce/rancher_bee'})
...
onEvent('item.tags', event => {
	event.get('tfc:forge_fuel').add('kubejs:coalcoke')
	...
	event.add('kubejs:glass_materials','kubejs:lime').add('kubejs:chalk')
	event.add('kubejs:stone_javelin_head','tfc:stone/javelin_head/igneous_extrusive').add('tfc:stone/javelin_head/igneous_intrusive').add('tfc:stone/javelin_head/metamorphic').add('tfc:stone/javelin_head/sedimentary')
	event.add('kubejs:tfc_grass','tfc:grass/silt').add('tfc:grass/loam').add('tfc:grass/sandy_loam').add('tfc:grass/silty_loam')
})
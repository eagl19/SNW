onEvent('recipes', event => {
	...
	const recipes=[		
		...
		{INPUT : SANDS.BLACK,			RESULTS: [ORETYPE.AMETHYST, ORETYPE.KAOLINITE,  ORETYPE.OPAL, 	   ORETYPE.SALTPETER, ORETYPE.SULFUR, 	 ORETYPE.SYLVITE, ORETYPE.BORAX, 	 ORETYPE.CINNABAR, ORETYPE.GYPSUM, ORETYPE.HALITE, ORETYPE.RUBY], KEY:'sand/black'},
		...
		{INPUT : SANDS.YELLOW,			RESULTS: [ORETYPE.AMETHYST, ORETYPE.KAOLINITE,  ORETYPE.LAPIS,     ORETYPE.OPAL, 	  ORETYPE.SALTPETER, ORETYPE.BORAX,   ORETYPE.HALITE, ORETYPE.RUBY], KEY:'sand/yellow'},
